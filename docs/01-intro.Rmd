...
```{r name-tag-brandon, echo=FALSE}
knitr::include_graphics("images/name-tag-brandon.jpg")
```

* [`r fontawesome::fa("globe", fill = "steelblue")`](https://bgreenwell.netlify.com/) https://bgreenwell.netlify.com/
* [`r fontawesome::fa("github", fill = "steelblue")`](https://github.com/bgreenwell/) @bgreenwell
* [`r fontawesome::fa("twitter", fill = "steelblue")`](https://twitter.com/bgreenwell8) @bgreenwell8
* [`r fontawesome::fa("envelope", fill = "steelblue")`](mailto:greenwell.brandon@gmail.com) greenwell.brandon@gmail.com
...
* 84.51° - Data Scientist <img src="images/logo8451.jpg" align="right" alt="family" width="150" />

#### Academic

* University of Cincinnati <img src="images/uc.png" align="right" alt="family" width="60" />

* Wright State University <img src="images/wsu.jpg" align="right" alt="family" width="60" />

#### R Community

<img src="images/hexes-brandon.png" alt="family" width="400" />
